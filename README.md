...
| [code-foundations](https://github.com/ryanthedev/code-foundations) | 2.7.2 | Software engineering skills from Code Complete & APOSD with three-level code review system |
