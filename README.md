...
|--------|---------|-------------|
| [oberskills](https://github.com/ryanthedev/oberskills) | 1.7.0 | Hypothesis-driven debugging, prompt engineering, agent dispatch, meta-planning, and plan execution |
